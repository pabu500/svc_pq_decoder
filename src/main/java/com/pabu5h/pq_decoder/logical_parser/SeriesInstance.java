...
//    #region [ Constructors ]
    ...
    public SeriesInstance(CollectionElement physicalStructure, ChannelInstance channel, SeriesDefinition definition)
    {
        ...
        this.getSeriesOffset();
        this.getSeriesScale();
        this.getSeriesShareChannel();
        this.getSeriesShareChannelIndex();
        this.getSeriesShareSeries();
        this.getSeriesShareSeriesIndex();
...
//        get
//        {
            return definition = m_definition;
//        }
    }
    ...
    /// </summary>
    ScalarElement seriesScale;
    public ScalarElement getSeriesScale()
    {
//        get
//        {
            return seriesScale = m_physicalStructure.getScalarByTag(SeriesScaleTag) == null ? 
            		(getSeriesShareSeries() == null ? null : getSeriesShareSeries().getSeriesScale())
            		: m_physicalStructure.getScalarByTag(SeriesScaleTag);
...
//        }
    ...
    /// </summary>
    ScalarElement seriesOffset;
    public ScalarElement getSeriesOffset()
    {
//        get
//        {
            return seriesOffset = m_physicalStructure.getScalarByTag(SeriesOffsetTag) == null 
            		? (getSeriesShareSeries() == null ? null : getSeriesShareSeries().getSeriesOffset()) : 
            			m_physicalStructure.getScalarByTag(SeriesOffsetTag);
...
//        get
//        {
            SeriesInstance seriesShareSeries = getSeriesShareSeries();

            return seriesValues = ((seriesShareSeries != null)
...
//    }
    ...
    /// </summary>
    Integer seriesShareChannelIndex;
...
//        {
            ...
            return seriesShareChannelIndex = ((seriesShareChannelIndexScalar != null)
...
//        }
    ...
    /// </summary>
    Integer seriesShareSeriesIndex;
...
//        {
            ...
            return seriesShareSeriesIndex = ((seriesShareSeriesIndexScalar != null)
...
//        }
    ...
    /// </summary>
    ChannelInstance seriesShareChannel;
    public ChannelInstance getSeriesShareChannel()
    {
//        get
//        {
            Integer seriesShareChannelIndex = getSeriesShareChannelIndex();

            return seriesShareChannel = ((seriesShareChannelIndex != null)
...
//        }
    ...
    /// </summary>
    SeriesInstance seriesShareSeries;
    public SeriesInstance getSeriesShareSeries()
    {
//        get
//        {
            Integer seriesShareSeriesIndex = getSeriesShareSeriesIndex();
            ChannelInstance seriesShareChannel = getSeriesShareChannel();
            ...
            return this.seriesShareSeries = seriesShareSeries;
//        }
    }
...
//        };
    ...
    List<Number> originalValues;
    public List<Number> getOriginalValues()
    {
        ...
        if (incremented)
        {
            ...
            if (rateCount.doubleValue() > 0)
            {
            	Number zero = rateCount.doubleValue() - rateCount.doubleValue();
            	Number one = rateCount.doubleValue() / rateCount.doubleValue();
            	Number start = zero;
                ...
                for (int i = 0; i < rateCount.intValue(); i++)
                {
                    ...
                    for (int j = zero.intValue(); j < count.intValue(); j = j + one.intValue())
                        values.add((start.doubleValue() + j * increment.doubleValue()));

                    start = count.doubleValue() * increment.doubleValue();
                }
            }
        }
        else
        ...
        if (valuesVector.getTypeOfValue() != PhysicalType.Timestamp)
        {
            ...
            {
                value = values.get(i);
                values.set(i, offset.doubleValue() + (value.doubleValue() * scale.doubleValue()));
            }
        ...
        for (int i = 0; i < values.size(); i++) {
        	Number vl = values.get(i);
        	if (vl instanceof Double) {
        		values.set(i, new BigDecimal(vl.doubleValue()).setScale(vl.doubleValue() == 0 ? 0 : 20, RoundingMode.HALF_UP));
        	}
        }
